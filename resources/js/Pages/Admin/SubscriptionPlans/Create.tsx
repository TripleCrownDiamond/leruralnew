...
export default function Create() {
    const { data, setData, post, processing, errors, transform } = useForm({
        ...
        is_featured: false,
        features_text: '',
        access_premium_articles: true,
        access_press_ecrite: false,
    });
    ...
    return (
        <DashboardLayout title="Nouveau plan">
            <Head title="Nouveau plan" />

            <form onSubmit={submit} className="space-y-8">
                <AdminPageHeader
                    eyebrow="Commerce"
                    title="Creer un plan d'abonnement"
                    subtitle="Definissez le tarif, la duree et les avantages comme pour vos pages Articles." 
                            ...
                            <div className="grid gap-5">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Resume rapide de l'offre"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder={"Acces aux contenus premium\nNewsletter prioritaire\nSans publicite"}
                            ...
                            <div className="space-y-4">
                                <label className="flex cursor-pointer items-center gap-3 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 dark:border-white/10 dark:bg-white/[0.03]">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500 dark:text-white/50">Disponible a la vente.</div>
                                    </div>
                                </label>
                                ...
                                <label className="flex cursor-pointer items-center gap-3 rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 dark:border-white/10 dark:bg-white/[0.03]">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500 dark:text-white/50">Badge vedette sur la page tarifs.</div>
                                    </div>
                                </label>
                            </div>
                        </section>
                        ...
                        <section className="rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/10 to-emerald-500/5 p-5 shadow-[0_18px_40px_-28px_rgba(47,106,17,0.28)] dark:border-primary/15 dark:from-primary/10 dark:to-emerald-500/10">
                            <div className="flex items-start gap-3">
                                ...
                                <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                                    Astuce: gardez des noms courts et une duree claire pour faciliter la comparaison des offres.
                                </p>
                            </div>
                        </section>
                    </aside>
