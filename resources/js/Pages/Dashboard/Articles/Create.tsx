...
import { buildStoredArticleContent, hasMeaningfulContent, htmlToMarkdown, markdownToHtml, type ArticleContentMode } from '@/lib/articleContent';
import { Head, useForm, usePage } from '@inertiajs/react';
import { ArrowLeft, CalendarClock, Code2, FileText, Newspaper, Sparkles } from 'lucide-react';
...
export default function Create({ categories }: Props) {
    ...
    const [publicationMode, setPublicationMode] = useState<'draft' | 'now' | 'scheduled'>('now');
    ...
    const { data, setData, post, processing, errors, transform } = useForm({
        ...
        content_fr: '',
        markdown_content_fr: '',
        content_mode: 'wysiwyg' as ArticleContentMode,
        featured_image: '',
        featured_image_position_x: 50,
        featured_image_position_y: 50,
        is_premium: false,
        price: '',
        published_at: '',
    ...
    return (
        <DashboardLayout title="Nouvel article">
            ...
            <form onSubmit={submit} className="space-y-8">
                    ...
                    subtitle="Redigez, planifiez et mettez en avant un nouveau sujet sans quitter l'administration."
                                ...
                                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                                    <div>
                                        ...
                                        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                            Choisissez un mode de redaction. Chaque mode garde son brouillon, sans conversion automatique.
                                        </p>
                                    </div>
                            ...
                            {data.content_mode === 'wysiwyg' ? (
                                <div className="mt-5">
                                    <TiptapEditor
                                        ...
                                        placeholder="Commencez la redaction de l'article..."
                                        className="mt-4"
                                    />
                                </div>
                            ) : (
                                <div className="mt-5 space-y-4">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="# Votre titre\n\nRedigez votre article en markdown..."
                                    ...
                                    <div className="rounded-2xl border border-dashed border-primary/30 bg-primary/5 px-4 py-3 text-xs leading-relaxed text-gray-600 dark:border-primary/20 dark:bg-primary/10 dark:text-gray-300">
                                        Le markdown sera publie automatiquement comme un article normal, avec conversion securisee en HTML a l'affichage.
                                    </div>
                                </div>
                            )}
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="mt-2 text-sm leading-relaxed text-gray-600 dark:text-gray-300">
                                        Verifiez le titre, les rubriques et la couverture avant publication pour garantir une home plus coherente.
                                    </p>
                                </div>
                            </div>
                        </section>
