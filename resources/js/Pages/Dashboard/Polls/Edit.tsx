...
export default function Edit({ poll }: { poll: any }) {
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            Modifiez les questions et options de votre sondage
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6 space-y-4">
                            ...
                            {/* Display errors for options array if any specific index fails */}
                            {Object.keys(errors).map((key) => {
                                if (key.startsWith('options.')) {
                                    return <InputError key={key} message={errors[key]} className="mt-1" />;
                                }
                                return null;
                            })}
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <InputLabel htmlFor="expires_at" value="Date d'expiration (Optionnel)" />
                                <TextInput
                                    id="expires_at"
                                    type="date"
                            ...
                            <div className="flex items-center space-x-2 pt-8">
                                ...
                                >
                                    Activer ce sondage immédiatement
                                </label>
                        </div>
                    </div>
                </div>
